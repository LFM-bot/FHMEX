...
EXP_HYPER_LIST = {'Data': {'dataset': None, 'item_id_pad': None, 'data_aug': None, 'seq_filter_len': None,
                           'if_filter_target': None, 'max_len': None, 'do_test_with_eval': None},
                  ...
                  'Evaluation': {'split_type': None, 'split_mode': None, 'eval_mode': None, 'metric': None, 'k': None,
                                 'valid_metric': None, 'eval_batch': None, 'mask_history': None, 'test_device': None},
...
def get_default_config():
    ...
    parser.add_argument('--item_id_pad', default=0, type=int, help='id = original_id + item_id_pad')
    ...
    # Text data
    parser.add_argument('--max_text_len', default=512, type=int, help='max sentence length')
    parser.add_argument('--llm_model_name_or_path', default=None, type=str, help='LLM model name or path')
    # Image data
    ...
    parser.add_argument('--mask_history', action='store_true', help='mask scores for historical items')
    parser.add_argument('--test_device', default='cuda:0', type=str, help='do test on cpu or cuda')
    parser.add_argument('--do_test_with_eval', default=False, type=bool, help='do test with eval')
    parser.add_argument('--eval_ratio', default=0.1, type=float, help='evaluation ratio')
